...
from reid.models.vip_pvt.ChannelGate import ChannelGate
...
class PWReid(nn.Module):
    ...
    def forward(self, x):
        ...
        feat3 = feats[2]
        feat4 = feats[3]
        x = self.gate(feat2) + self.gate(feat3) + self.gate(feat4)
...
@register_model
def pvt_v2_b2_p(pretrained=False, **kwargs):
    model = PWReid(
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
